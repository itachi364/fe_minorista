...
public class EntidadValidator {
    ...
    public TipoDocumentoResponseDTO obtenerTipoDocumento(Long codigo) {
        return tipoDocumentoClient.obtenerTipoDocumentoPorCodigo(codigo);
    }

    public TipoClienteEnum determinarTipoCliente(Long idTipoDocumento) {
        return (idTipoDocumento == 31 || idTipoDocumento == 50)
