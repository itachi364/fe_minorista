...
import com.msvanegasg.facturaelectronica.inventory.application.usecase.ProductAlreadyExistsException;
import com.msvanegasg.facturaelectronica.inventory.application.usecase.ProductNotFoundException;
import com.msvanegasg.facturaelectronica.inventory.application.usecase.PurchaseNotFoundException;
...
public class InventoryExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleDuplicate(RuntimeException exception, HttpServletRequest request) {
