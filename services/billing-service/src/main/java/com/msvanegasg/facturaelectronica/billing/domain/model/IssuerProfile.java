...
public final class IssuerProfile {
    ...
    private IssuerProfile(UUID id, UUID companyId, String legalName, String nit, String verificationDigit,
            List<String> taxResponsibilities, String municipalityCode, String address, boolean active) {
        this.id = id;
    ...
    public static IssuerProfile configure(UUID id, UUID companyId, String legalName, String nit,
            String verificationDigit, List<String> taxResponsibilities, String municipalityCode, String address) {
    ...
    public static IssuerProfile restore(UUID id, UUID companyId, String legalName, String nit,
            String verificationDigit, List<String> taxResponsibilities, String municipalityCode, String address,
            boolean active) {
        requireNonNull(id, "id");
        requireNonNull(companyId, "companyId");
    ...
    public String verificationDigit() { return verificationDigit; }
    public List<String> taxResponsibilities() { return taxResponsibilities; }
