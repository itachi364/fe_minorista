...
import com.msvanegasg.facturaelectronica.billing.application.usecase.RegisterFiscalAuditEventService;
...
public class BillingUseCaseConfiguration {
    ...
    @Bean
    RegisterFiscalAuditEventUseCase registerFiscalAuditEventUseCase(
            FiscalAuditEventRepositoryPort auditEventRepository,
            IdGeneratorPort idGenerator,
            ClockPort clock) {
        return new RegisterFiscalAuditEventService(auditEventRepository, idGenerator, clock);
    }
    ...
    RegisterProviderSubmissionOutcomeUseCase registerProviderSubmissionOutcomeUseCase(
            ...
            RegisterFiscalAuditEventUseCase registerAuditEventUseCase,
            IdGeneratorPort idGenerator,
            ClockPort clock) {
        return new RegisterProviderSubmissionOutcomeService(documentRepository, traceEventRepository,
                registerAuditEventUseCase, idGenerator, clock);
    }
