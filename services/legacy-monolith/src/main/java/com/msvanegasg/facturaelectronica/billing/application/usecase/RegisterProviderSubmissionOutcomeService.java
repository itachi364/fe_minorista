...
public class RegisterProviderSubmissionOutcomeService implements RegisterProviderSubmissionOutcomeUseCase {
    ...
    private final RegisterFiscalAuditEventUseCase registerAuditEventUseCase;
    ...
    public RegisterProviderSubmissionOutcomeService(
        ...
        this.registerAuditEventUseCase = Objects.requireNonNull(registerAuditEventUseCase);
    ...
    public ElectronicDocumentStatusResult register(RegisterProviderSubmissionOutcomeCommand command) {
        ...
        registerAuditEventUseCase.register(new RegisterFiscalAuditEventCommand(
                command.companyId(),
                command.documentId(),
                RESOURCE_TYPE,
                action.name(),
