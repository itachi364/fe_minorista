...
public final class NumberingResolution {
    ...
    public static NumberingResolution restore(
            UUID id,
            UUID companyId,
            ElectronicDocumentType documentType,
            String resolutionNumber,
    ...
    public boolean isAvailableFor(
            ...
            ElectronicDocumentType requestedDocumentType,
            LocalDate documentDate,
            FiscalEnvironment requestedEnvironment) {
        return active
                && companyId.equals(requestedCompanyId)
                && documentType == requestedDocumentType
                && environment == requestedEnvironment
                && !documentDate.isBefore(validFrom)
                && !documentDate.isAfter(validTo)
                && hasNumbersAvailable();
    }

    public FiscalNumberAssignment assignNextNumber(
            UUID requestedCompanyId,
            ElectronicDocumentType requestedDocumentType,
            LocalDate documentDate,
            FiscalEnvironment requestedEnvironment) {
    ...
    private boolean hasNumbersAvailable() {
