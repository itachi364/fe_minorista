...
public class AssignFiscalNumberService implements AssignFiscalNumberUseCase {
    ...
    public AssignFiscalNumberService(
    ...
    public FiscalNumberResult assign(AssignFiscalNumberCommand command) {
        ...
        NumberingResolution resolution = numberingResolutionRepository.findActiveResolution(
                command.companyId(),
        ...
        FiscalNumberAssignment assignment = resolution.assignNextNumber(
                command.companyId(),
                command.documentType(),
                command.documentDate(),
                command.environment());
        ...
        return new FiscalNumberResult(
                assignment.resolutionId(),
                assignment.resolutionNumber(),
                assignment.prefix(),
                assignment.number());
    }
}
