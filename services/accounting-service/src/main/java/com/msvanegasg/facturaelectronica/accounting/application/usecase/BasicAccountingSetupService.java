...
public class BasicAccountingSetupService implements InitializeBasicAccountingSetupUseCase {
    ...
    private static List<AccountTemplate> accountTemplates() {
        return List.of(
                ...
                new AccountTemplate("2365", "Retencion en la fuente"),
                new AccountTemplate("2367", "Impuesto a las ventas retenido"),
                new AccountTemplate("2368", "Impuesto de industria y comercio retenido"),
        ...
        return List.of(
                ...
                new RuleTemplate(AccountingEventType.PURCHASE_CONFIRMED, AccountingSourceType.PURCHASE,
                        "Factura de compra - plantilla basica", List.of(
                                ...
                                new RuleLineTemplate("2408", AccountingEntrySide.DEBIT, AccountingAmountType.TAX_TOTAL,
                                        "IVA descontable"),
                                new RuleLineTemplate("2205", AccountingEntrySide.CREDIT,
                                        AccountingAmountType.NET_PAYABLE, "Proveedor o cuenta por pagar"),
                                new RuleLineTemplate("2365", AccountingEntrySide.CREDIT,
                                        AccountingAmountType.RETEFUENTE, "Retencion en la fuente por pagar"),
                                new RuleLineTemplate("2367", AccountingEntrySide.CREDIT,
                                        AccountingAmountType.RETEIVA, "ReteIVA por pagar"),
                                new RuleLineTemplate("2368", AccountingEntrySide.CREDIT,
                                        AccountingAmountType.RETEICA, "ReteICA por pagar"))),
