...
- RF-281: El modulo de Configuracion DIAN debe reemplazar la captura de certificado como texto por carga segura de archivo `.p12` o `.pfx`, con password de certificado como secreto de solo entrada, validacion de extension/tamano/tipo, extraccion de metadata no sensible y almacenamiento por referencia segura.
