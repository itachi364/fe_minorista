...
- RN-084: Una resolucion o emision electronica `ELECTRONIC_INVOICE`, `ELECTRONIC_POS`, notas credito/debito o nota de ajuste POS solo puede habilitarse cuando la empresa tenga configuracion DIAN propia en modo `REAL`, activa, probada exitosamente y con certificado configurado. Sin esa condicion, solo se permite `NON_FISCAL_SALE`, que no imprime CUFE/CUDE ni QR DIAN.
