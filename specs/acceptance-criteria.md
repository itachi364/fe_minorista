...
- AC-377: Dada una empresa con contabilidad basica inicializada antes de una nueva plantilla, cuando se ejecute nuevamente `Iniciar contabilidad basica`, entonces se crean solo las cuentas/reglas faltantes y se conservan reglas activas existentes.
