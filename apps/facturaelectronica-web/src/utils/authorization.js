export const stepPermissionRules = {
  Empresa: ['COMPANY_SETTINGS_MANAGE', 'FISCAL_SETTINGS_MANAGE', 'GLOBAL_COMPANIES_MANAGE'],
  'Puesta en marcha': ['COMPANY_SETTINGS_MANAGE', 'ACCOUNTING_VIEW', 'ACCOUNTING_MANAGE'],
  DIAN: ['FISCAL_SETTINGS_MANAGE'],
  Licencias: ['GLOBAL_COMPANIES_MANAGE'],
  Terceros: ['COMPANY_SETTINGS_MANAGE'],
  Finanzas: ['REPORTS_VIEW', 'ACCOUNTING_VIEW', 'ACCOUNTING_MANAGE'],
  ...
  Fiscal: ['FISCAL_SETTINGS_MANAGE'],
  'Reglas fiscales': ['FISCAL_SETTINGS_MANAGE'],
