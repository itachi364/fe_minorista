export const navigationGroups = [
  ...
  { label: 'Contabilidad', items: ['Finanzas', 'Terceros', 'Inventario', 'Compras', 'Gastos', 'Deudores', 'Fiscal', 'Catalogo fiscal', 'Documentos fiscales', 'Configuracion contable', 'Nomina'] },
